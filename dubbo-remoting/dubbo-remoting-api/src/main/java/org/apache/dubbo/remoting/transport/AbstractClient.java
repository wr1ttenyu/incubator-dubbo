...
public abstract class AbstractClient extends AbstractEndpoint implements Client {
    ...
    /**
     * 重连 warning 的间隔.(重连多少次之后，warning一次) //for test
     */
    ...
    public AbstractClient(URL url, ChannelHandler handler) throws RemotingException {
        ...
        // 获得线程池
        // DataStore 在 dubbo-common 模块，store 包下实现。
        // 目前的实现比较简单，可以认为是 ConcurrentMap<String, ConcurrentMap<String, Object>> 的集合
            ...
            Runnable connectStatusCheckCommand = new Runnable() {
                ...
                public void run() {
                    try {
                        ...
                        // 为什么要符合条件才打印呢？之前也和朋友聊起来过，线上因为中间件组件，打印了太多的日志，结果整个 JVM 崩了。
                        // 特别在网络场景 + 大量“无限”重试的场景，特别容易打出满屏的日志。
                        // 这块，我们可以学习下。另外，Eureka 在集群同步，也有类似处理
